 ...
 * growth will not occur if {@link Ext.ux.form.field.Tag#multiSelect} or
 * {@link Ext.ux.form.field.Tag#grow} is false.
 */
Ext.define('Ext.ux.layout.component.field.Tag', {
    /* Begin Definitions */
    alias: ['layout.tag'],
